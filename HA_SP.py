...
plt.plot(houses_list, avg_welfare_max, label='Max Welfare Allocation', marker='o')
plt.plot(houses_list, avg_welfare_fair, label='Min #Envy Allocation', marker='x')
plt.xlabel('Number of Houses')
plt.ylabel('Average Total Welfare')
plt.title('Welfare Loss in the Min #Envy Allocation for Single Peaked Preferences')
plt.legend()
plt.grid(True)
plt.show()
